:quickstart-project-name: quickstart-nvidia-cloudxr
...
:aws-contributors: Sahil Saini, Autodesk Solutions Architect and Marcos Hernandez Alvarez, AWS Solutions Architect
